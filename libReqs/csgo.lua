...
-- library init
    ...
    if not isfile(library.directory .. "/fonts/main.ttf") then 
        writefile(library.directory .. "/fonts/main.ttf", game:HttpGet("https://github.com/FadeRemix/RobloxThings/raw/refs/heads/main/libReqs/ProggyTiny.ttf"))
    end 
